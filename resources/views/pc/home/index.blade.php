...
<head>
    ...
    <title>中华江州义门陈氏</title>
    <meta name="renderer" content="webkit">
    <meta http-equiv="Cache-Control" content="no-siteapp"/>
    <link rel="icon" type="image/png" href="{{ url('build/i/favicon.png') }}">
    <meta name="mobile-web-app-capable" content="yes">
    <link rel="icon" sizes="192x192" href="{{ url('build/i/app-icon72x72@2x.png') }}">
    <meta name="apple-mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-status-bar-style" content="black">
    <meta name="apple-mobile-web-app-title" content="chen mr"/>
    <link rel="apple-touch-icon-precomposed" href="{{ url('build/i/app-icon72x72@2x.png') }}">
    <meta name="msapplication-TileImage" content="{{ url('build/i/app-icon72x72@2x.png') }}">
...
<div class="am-g am-g-fixed blog-fixed am-u-sm-centered blog-article-margin">
    <div data-am-widget="slider" class="am-slider am-slider-b1" data-am-slider='{&quot;controlNav&quot;:false}' >
        <ul class="am-slides">
            <li>
                <img src="{{ url('build//i/b1.jpg') }}">
            </li>
            <li>
                <img src="{{ url('build//i/b2.jpg') }}">
            </li>
            <li>
                <img src="{{ url('build//i/b3.jpg') }}">
            </li>
            <li>
                <img src="{{ url('build//i/b2.jpg') }}">
            </li>
...
<footer class="blog-footer">
    <div class="blog-text-center">© 2017 版权所有，归江州义门陈所有</div>
</footer>
